...
>>>>>>> 01c76dbfd7402cfa011301004162c1f190723290
);
...
=======
    PRIMARY KEY(ID_usuario,ID_servicio,fecha_orden),
    CONSTRAINT fk_ordenes_idUsuario FOREIGN KEY (ID_Usuario) REFERENCES Clientes(ID_Usuario) ON DELETE SET NULL  ON UPDATE CASCADE,
